...
impl HandleAbout {
    pub async fn about(hb: web::Data<Handlebars<'_>>) -> HttpResponse {
        ...
        let about_content = json!({
            "content": "Welcome to my website! This space is where I get to share some of my favorite things with you — books that have left a lasting impact, music that resonates with my soul, and more.
            ...
            Inspirations:
            One of my greatest inspirations is Johannes Kepler. This German astronomer, mathematician, and astrologer played a pivotal role in the 17th-century scientific revolution. His laws of planetary motion have forever shaped our understanding of the cosmos. What captivates me most about Kepler is not just his groundbreaking contributions but his humility in the face of monumental achievements. His modesty fuels my curiosity for space studies, and I aspire to approach my interests with the same sense of wonder and humility.
